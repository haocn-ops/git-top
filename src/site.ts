...
export function renderLlmsFullTxt(): Response {
  return text(
    [
      ...
      "",
      "Atlas journeys expose reusable routes across ecosystems. GET /api/journeys returns journeys, journeys[].steps, stats, ecosystem_id, and metadata so agents can turn a map into an ordered exploration plan.",
      "",
      "## Trends",
      "",
