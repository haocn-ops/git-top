...
Generated at: 2026-06-21T02:42:02.888Z
...
`exact_intent_guard` | 0.619 | 0.952 | 0 | 0.818 | 0.909 | 0 | Boost quality inside scopes while preserving exact project-name and owner intent.
...
- Local focus: `local-category-coding_agent`, `local-category-llm_eval`, `local-category-prompt_tooling`, `local-deployment-docker`
